...
const MainPage = () => {
  ...
  return (
    <div className="relative">
      ...
      <div
        id="section0"
        className="min-h-screen lg:bg-contain flex justify-center items-center bg-backAlma bg-fixed bg-cover bg-no-repeat bg-center"
      >
        <div className="flex flex-col justify-center items-center ">
          <h1 className="text-8xl text-white sm:text-9xl select-none font-bodiee">
            Alma
          </h1>
          <h2 className="text-5xl  text-amber-200 sm:text-6xl select-none font-bodie">
            Mis XV
          </h2>
        </div>
      </div>
      ...
      >
        ...
        >
          <h1 className="flex justify-center text-3xl pb-6 text-fuchsia-800/75 font-bodie font-medium">
            INSTAGRAM
          </h1>
        </motion.div>
        <motion.div
        ...
        >
          <div className="block justify-center text-center text-2xl pb-6 font-bodie text-fuchsia-900/100">
      ...
      <div
        id="section4"
        className="flex flex-col justify-center items-center p-16 font-serif bg-white"
      >
        <motion.div
          initial={{ x: 150, opacity: 0 }}
          whileInView={{ x: 0, opacity: 1 }}
        ...
        >
          <div className="flex justify-center pb-6">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-20 h-20 fill-none stroke-amber-300"
              viewBox="0 0 24 24"
              stroke-width="1.5"
              stroke="currentColor"
            >
        ...
        >
          <h1 className="flex justify-center text-3xl pb-6 text-amber-300 font-bodie font-medium">
            REGALO
          </h1>
        </motion.div>
        <motion.div
        ...
        >
          <div className="block justify-center text-center text-2xl pb-6 font-bodie  text-amber-300 w-[400px]">
            <h3>
      ...
      <div className="flex flex-col justify-center items-center p-14 font-serif bg-amber-200">
        ...
        >
          <div className="flex justify-center pb-6">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="fill-none stroke-white stroke-1 h-20 w-20"
              viewBox="0 0 24 24"
              stroke-width="1.5"
              stroke="currentColor"
            >
        ...
        <div className="text-center block justify-center font-bodie">
          ...
          >
            <h1 className="text-4xl text-white font-bodie font-semibold ">
              Confirmar
            </h1>
            <h1 className="text-4xl pb-6 text-white font-bodie font-semibold">
              asistencia
            </h1>
            <div className="text-2xl pb-6 text-white">
